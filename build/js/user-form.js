...
// Событие для изминения цвета fireball
...
// Event for changing the color of the cloak
...
// ЗLaunching the Pristine library
...
// Function of submitting a form to the server
	...
	wizardForm.addEventListener('submit', (evt) => {
		...
		if (isValid) {
			...
			sendData(
				...
				() => {
					showAlert('Failed to submit form. Try again');
					unblockSubmitButton();
				},
